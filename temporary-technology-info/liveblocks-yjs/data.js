...
export const data = LandscapeSchema.make({
  ...
  ClientSideData: {
    ...
    LocalRefreshLatency: {
      data: '<1ms',
      comment:
        'Changes on the client: <1ms. Other clients receive updates up to 60 times per second(16ms), configurable.',
    },
    PersistenceMechanism: {
      data: ['Yjs'],
    },
    ...
    DataSize: {
      ...
      comment:
        'It depends on the in memory size of the yjs store and the history of the document.',
    },
  },
